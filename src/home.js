function home() {
    ...
    welcomeText.append(
        welcomeSpan,
        "We are a four start vegan only Restaurant in Austin, Texas. Come and visit us. You will not be disappointed!"
    );
    ...
    rightQuestionOneText.textContent = "Yes, you can reserve a table at our restaurant. You can reserve a table by calling us or by sending us an email. We will contact you as soon as possible.";
    ...
    githubLink.href = "https://github.com/LalaineHines";
