function contact() {
    ...
    personOneName.textContent = "Cao Duc Vy";
    const personOneDescription = create("p");
    personOneDescription.textContent = "I eat sushi and sushi and I usually get pretty good. But when it comes to sushi I love making great sushi! I got a lot of great sushi that I have not eaten in years. The great ones are my personal favourite and I have been making and selling some for over 30 years now. These amazing sushi items were made on my own and I make them myself. I really loved them! So I make them again and again. My mom makes them every day in the kitchen making so many of them. I find that sometimes it takes days before I get a good sushi.";
    ...
    address.textContent = "Vegan Chef, 123 Fake Street, Fake City, Fake State, 12345";
    ...
    const info = create ("p");
    info.textContent = "THIS IS NOT A REAL RESTAURANT. THIS IS AN EXAMPLE TEMPLATE ONLY.";
    addressDiv.append(
        addressHeader,
        address,
        phoneHeader,
    ...
    githubLink.href = "https://github.com/LalaineHines/Restuarant-page";
